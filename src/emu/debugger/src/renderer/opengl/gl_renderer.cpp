...
namespace eka2l1 {
    static const GLchar *vertex_shader_debugger = "#version 330\n"
...
#undef OFFSETOF
    ...
    void debugger_gl_renderer::draw(std::uint32_t width, std::uint32_t height, std::uint32_t fb_width, std::uint32_t fb_height) {
        auto &io = ImGui::GetIO();
