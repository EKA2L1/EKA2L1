...
namespace eka2l1::epoc {
    ...
    struct eka1_executor {
        ...
        enum attribute_epoc6 {
            ...
            execute_v6_kill_process = 0x21,
            execute_v6_terminate_process = 0x22,
            execute_v6_panic_process = 0x23,
        ...
        enum attribute_epoc80a {
            ...
            execute_v80_kill_process = 0x21,
            execute_v80_terminate_process = 0x22,
            execute_v80_panic_process = 0x23,
        ...
        enum attribute_epoc81a {
            ...
            execute_v81a_kill_process = 0x21,
            execute_v81a_terminate_process = 0x22,
            execute_v81a_panic_process = 0x23,
