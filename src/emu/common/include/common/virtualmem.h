...
namespace eka2l1::common {
    ...
    */
     ...
     *
     * \params ptr The pointer poiting to target region
     * \params size Size to unmap
     * 
    ...
    */
     ...
     *
     * \params ptr Pointer to the target region.
     * \params size Size of the memory to be committed.
     * \params prot The initial protection.
     * 
    ...
    */
     ...
     *
     * \params ptr Pointer to the target region.
     * \params size Size of the memory to be decommitted.
     * 
     * \returns True on success, false on failure.
    */
     ...
     *
     * \params ptr Pointer to the target region.
     * \params size Size of the memory to be change.
     * \params prot The new protection.
     * 
     * \returns True on success, false on failure.
    */
