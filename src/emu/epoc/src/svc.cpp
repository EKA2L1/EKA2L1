...
namespace eka2l1::epoc {
    ...
    */
    ...
    const eka2l1::hle::func_map svc_register_funcs_v93 = {
        ...
        BRIDGE_REGISTER(0x78, ProcessRename),
        BRIDGE_REGISTER(0x7A, ProcessLogon),
        ...
        BRIDGE_REGISTER(0x9E, LibraryAttached),
        BRIDGE_REGISTER(0x9F, StaticCallList),
        BRIDGE_REGISTER(0xA2, LastThreadHandle),
        BRIDGE_REGISTER(0xA4, ProcessRendezvous),
        BRIDGE_REGISTER(0xA7, MessageIpcCopy),
        BRIDGE_REGISTER(0xAD, ProcessSecurityInfo),
        BRIDGE_REGISTER(0xAE, ThreadSecurityInfo),
        BRIDGE_REGISTER(0xB8, MessageQueueNotifyDataAvailable),
        BRIDGE_REGISTER(0xBB, PropertyDefine),
        BRIDGE_REGISTER(0xBD, PropertyAttach),
        BRIDGE_REGISTER(0xBE, PropertySubscribe),
        BRIDGE_REGISTER(0xBF, PropertyCancel),
        BRIDGE_REGISTER(0xC0, PropertyGetInt),
        BRIDGE_REGISTER(0xC4, PropertyFindGetInt),
        BRIDGE_REGISTER(0xC5, PropertyFindGetBin),
        BRIDGE_REGISTER(0xC6, PropertyFindSetInt),
