...
namespace eka2l1::arm {
    ...
    public:
        virtual std::uint8_t exclusive_read8(std::size_t core_index, address vaddr) = 0;
        virtual std::uint16_t exclusive_read16(std::size_t core_index, address vaddr) = 0;
        virtual std::uint32_t exclusive_read32(std::size_t core_index, address vaddr) = 0;
        virtual std::uint64_t exclusive_read64(std::size_t core_index, address vaddr) = 0;
        virtual void clear_exclusive() = 0;

        virtual bool exclusive_write8(std::size_t core_index, address vaddr, std::uint8_t value) = 0;
        virtual bool exclusive_write16(std::size_t core_index, address vaddr, std::uint16_t value) = 0;
        virtual bool exclusive_write32(std::size_t core_index, address vaddr, std::uint32_t value) = 0;
        virtual bool exclusive_write64(std::size_t core_index, address vaddr, std::uint64_t value) = 0;
    };
