...
namespace eka2l1::dispatch {
    const eka2l1::dispatch::func_map dispatch_funcs = {
        ...
        //BRIDGE_REGISTER_DISPATCHER(0x11AF, egl_bind_api_emu),
        //BRIDGE_REGISTER_DISPATCHER(0x11B0, egl_create_pbuffer_from_client_buffer_emu),
        //BRIDGE_REGISTER_DISPATCHER(0x11B1, egl_query_api_emu),
        //BRIDGE_REGISTER_DISPATCHER(0x11B2, egl_release_thread_emu),
        //BRIDGE_REGISTER_DISPATCHER(0x11B3, egl_wait_client_emu),
        //BRIDGE_REGISTER_DISPATCHER(0x11B4, gl_current_palette_matrix_oes_emu),
        //BRIDGE_REGISTER_DISPATCHER(0x11B5, gl_draw_texf_oes_emu),
        //BRIDGE_REGISTER_DISPATCHER(0x11B6, gl_draw_texfv_oes_emu),
        //BRIDGE_REGISTER_DISPATCHER(0x11B7, gl_draw_texi_oes_emu),
        //BRIDGE_REGISTER_DISPATCHER(0x11B8, gl_draw_texiv_oes_emu),
        //BRIDGE_REGISTER_DISPATCHER(0x11B9, gl_draw_texs_oes_emu),
        //BRIDGE_REGISTER_DISPATCHER(0x11BA, gl_draw_texsv_oes_emu),
        //BRIDGE_REGISTER_DISPATCHER(0x11BB, gl_draw_texx_oes_emu),
        //BRIDGE_REGISTER_DISPATCHER(0x11BC, gl_draw_texxv_oes_emu),
        //BRIDGE_REGISTER_DISPATCHER(0x11BD, gl_load_palette_from_model_view_matrix_oes_emu),
        //BRIDGE_REGISTER_DISPATCHER(0x11BE, gl_matrix_index_pointer_oes_emu),
        //BRIDGE_REGISTER_DISPATCHER(0x11BF, gl_weight_pointer_oes_emu),
    };
}