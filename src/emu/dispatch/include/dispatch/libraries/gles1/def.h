...
namespace eka2l1::dispatch {
    ...
    public:
        ...
        drivers::handle push_buffer(const std::uint8_t *data, const gles1_vertex_attrib &attrib, const std::int32_t first_index, const std::size_t vert_count, std::size_t &buffer_offset);
