...
void frameClockWindow(const FrameClock &clock) {
    ...
    Text("Time");
    NextColumn();
    Text(detail::stringPrecision(clock.getTotalFrameTime()).c_str());
    NextColumn();
    Text("(sec)");
    NextColumn();
    ...
    Text("Frame");
    NextColumn();
    Text(detail::stringPrecision(clock.getTotalFrameCount()).c_str());
    NextColumn();
    NextColumn();
    ...
    Text("FPS");
    NextColumn();
    Text(detail::stringPrecision(clock.getFramesPerSecond()).c_str());
    NextColumn();
    NextColumn();

    Text("min.");
    NextColumn();
    Text(detail::stringPrecision(clock.getMinFramesPerSecond()).c_str());
    NextColumn();
    NextColumn();

    Text("avg.");
    NextColumn();
    Text(detail::stringPrecision(clock.getAverageFramesPerSecond()).c_str());
    NextColumn();
    NextColumn();

    Text("max.");
    NextColumn();
    Text(detail::stringPrecision(clock.getMaxFramesPerSecond()).c_str());
    NextColumn();
    NextColumn();
    ...
    Text("Delta");
    NextColumn();
    Text(detail::stringPrecision(clock.getLastFrameTime() * 1000.0f).c_str());
    NextColumn();
    Text("(ms)");
    NextColumn();
    ...
    Text("min.");
    NextColumn();
    Text(detail::stringPrecision(clock.getMinFrameTime() * 1000.0f).c_str());
    NextColumn();
    Text("(ms)");
    NextColumn();
    ...
    Text("avg.");
    NextColumn();
    Text(detail::stringPrecision(clock.getAverageFrameTime() * 1000.0f).c_str());
    NextColumn();
    Text("(ms)");
    NextColumn();
    ...
    Text("max.");
    NextColumn();
    Text(detail::stringPrecision(clock.getMaxFrameTime() * 1000.0f).c_str());
    NextColumn();
    Text("(ms)");
    NextColumn();
